 ...
 *
 */
class DocRequest extends Plugin
{
    // Static Properties
    // =========================================================================
    ...
    public function init()
    {
        ...
        Event::on(
            ...
            function (RegisterUrlRulesEvent $event) {
                $event->rules['siteActionTrigger1'] = 'doc-request/submission';
            }
        );
...
//            function (RegisterUrlRulesEvent $event) {
//                $event->rules['cpActionTrigger1'] = 'doc-request/submission/do-something';
//            }
//        );
        ...
        Event::on(
            ...
            function (RegisterComponentTypesEvent $event) {
                $event->types[] = RequestsField::class;
            }
        );
        ...
        Event::on(
            ...
            function (Event $event) {
                ...
                $variable->set('docRequest', DocRequestVariable::class);
            }
        );
