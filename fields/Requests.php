...
namespace welove9am\docrequest\fields;

use welove9am\docrequest\DocRequest;
use welove9am\docrequest\assetbundles\requestsfield\RequestsFieldAsset;
...
class Requests extends Field
{
    ...
    {
        return Craft::t('doc-request', 'Requests');
    }
    ...
    public function getSettingsHtml()
    {
        ...
        return Craft::$app->getView()->renderTemplate(
            'doc-request/_components/fields/Requests_settings',
            [
                'field' => $this,
            ]
        );
    ...
    public function getInputHtml($value, ElementInterface $element = null): string
    {
        ...
        Craft::$app->getView()->registerAssetBundle(RequestsFieldAsset::class);
        ...
        Craft::$app->getView()->registerJs("$('#{$namespacedId}-field').DocRequestRequests(" . $jsonVars . ");");

        // Render the input template
        return Craft::$app->getView()->renderTemplate(
            'doc-request/_components/fields/Requests_input',
            [
                'element' => $element,
                'name' => $this->handle,
                'value' => $value,
